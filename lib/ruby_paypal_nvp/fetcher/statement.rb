module RubyPaypalNvp
  class StatementFetcher < BaseFetcher
    ...
    def process_loaded_data(account, result)
      ...
      # )
      # statement.update(confirmed: true, new_modifier_id: 'uoladm')
    end
    ...
    def load_response
      ...
      result = result_with_meta(account, timestamp: response['TIMESTAMP'])
